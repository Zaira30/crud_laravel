                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('date_birth') ? ' has-error' : '' }}">
                            <label for="email" class="col-md-4 control-label">Data Nascimento</label>

                            <div class="col-md-6">
                                <input id="email" type="date" class="form-control" name="date_birth" value="{{ old('date_birth') }}" required>
